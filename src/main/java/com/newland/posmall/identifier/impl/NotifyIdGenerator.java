 ...
 * @author lance
 */
@Component("notifyIdGenerator")
public class NotifyIdGenerator extends HiLoIdGenerator implements
		IdentifierGenerator {

	private static final String IDGEN_NAME = "NOTIFY_ID";
	...
	public NotifyIdGenerator() {
		this(MAXLENGTH);
	}

	protected NotifyIdGenerator(int maxLength) {
