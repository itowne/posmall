 ...
 * @author lance
 */
@Component("monIdGenerator")
public class MonIdGenerator extends HiLoIdGenerator implements
		IdentifierGenerator {

	private static final String IDGEN_NAME = "MONT_ID";
	...
	public MonIdGenerator() {
		this(MAXLENGTH);
	}

	protected MonIdGenerator(int maxLength) {
