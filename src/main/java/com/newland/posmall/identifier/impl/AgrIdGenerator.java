 ...
 * @author lance
 */
@Component("agrIdGenerator")
public class AgrIdGenerator extends HiLoIdGenerator implements
		IdentifierGenerator {

	private static final String IDGEN_NAME = "AGR_ID";
	...
	public AgrIdGenerator() {
		this(MAXLENGTH);
	}

	protected AgrIdGenerator(int maxLength) {
