 ...
 * @author lance
 */
@Component("interflowIdGenerator")
public class InterflowIdGenerator extends HiLoIdGenerator implements
		IdentifierGenerator {

	private static final String IDGEN_NAME = "FLOW_ID";
	...
	public InterflowIdGenerator() {
		this(MAXLENGTH);
	}

	protected InterflowIdGenerator(int maxLength) {
