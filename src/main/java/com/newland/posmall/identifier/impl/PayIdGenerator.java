 ...
 * @author lance
 */
@Component("payIdGenerator")
public class PayIdGenerator extends HiLoIdGenerator implements
		IdentifierGenerator {

	private static final String IDGEN_NAME = "PAY_ID";
	...
	public PayIdGenerator() {
		this(MAXLENGTH);
	}

	protected PayIdGenerator(int maxLength) {
