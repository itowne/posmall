 ...
 * @author lance
 */
@Component("custIdGenerator")
public class CustIdGenerator extends HiLoIdGenerator implements
		IdentifierGenerator {

	private static final String IDGEN_NAME = "CUST_ID";
	...
	public CustIdGenerator() {
		this(MAXLENGTH);
	}

	protected CustIdGenerator(int maxLength) {
