...
<div class="pageContent">
	<form method="post" action="${ctx}/sys/userrole/userroleToMod.do" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
	    <input name="iuserrole" type="hidden" value="${role.iuserrole}">
		<div class="pageFormContent" layoutH="56">
			<p>
				<label>角色名称：</label>
				<input name="name" type="text" size="30" value="${role.name}"/>
			</p>
			<p>
				<label>备注：</label>
				<input name="memo" type="text" size="30" value="${role.memo}"/>
			</p>
		<p>
				<label>菜单与权限设置：</label>
			</p>
