...
<div class="pageContent">
	<form method="post" action="${ctx}/sys/custrole/custroleToMod.do" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
	    <input name="icustrole" type="hidden" value="${role.icustrole}">
