...
<div class="pageContent">
	<form id="sysroleDetailForm" method="post" action="" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
...
<c:forEach var="authCode" items="${authCodeList}">
	var an = '${authCode}';
	$("#sysroleDetailForm input[value='"+an+"']").attr("checked","checked");
</c:forEach>
</script>
