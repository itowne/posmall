...
<div class="pageContent">
	<form method="post" action="${ctx}/sys/sysrole/sysroleToMod.do" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
	    <input name="isysrole" type="hidden" value="${role.isysrole}">
