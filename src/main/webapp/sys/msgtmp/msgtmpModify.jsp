...
function validMsgTmp(){
	var tmpType=$("#msgtmpModifyForm select[name='tmpType'] option:selected").val();
	var tmpCode = $("#msgtmpModifyForm input[name='tmpCode']").val();
	var id = $("#msgtmpModifyForm input[name='imsgTmp']").val();
	var v;
	   $.ajax({  
	    type: "GET",  
	    contentType : "application/json",
	    url: "${ctx}/sys/msgtmp/validateMsgTmpUniq.do?tmpType="+encodeURI(tmpType)+"&tmpCode="+encodeURI(tmpCode)+"&id="+id,
	    dataType:"json",
	    async:false,  
...
<div class="pageContent">
	<form id="msgtmpModifyForm" method="post" action="${ctx}/sys/msgtmp/msgtmpModify.do"
		class="pageForm required-validate"
		onsubmit="return validateCallback(this, dialogAjaxDone)">
		<div class="pageFormContent" layoutH="68">
		    <input type="hidden" name="imsgTmp" value="${tmsgtmp.imsgTmp}"/>
			<p>
				<label>模板类型：</label>
			...
			<ul>
				<li><div class="button">
						<div class="buttonContent">
							<button type="submit" onclick="return validMsgTmp();">&nbsp;&nbsp;确认修改&nbsp;&nbsp;</button>
						</div>
					</div></li>
				<li><div class="button">
						<div class="buttonContent">
