...
<body>
	<div id="login">
		...
		<div id="login_content">
			<div class="loginForm">
				<form id="sysloginForm" action="${ctx}/sys/authenticate.do" method="post"
					...
					<p>
						...
						%>
						<a href="javascript:void(0)" title="刷新验证码"><img
							src="${ctx}/kaptcha.jpg?d=<%=random%>" alt="" width="75"
							height="24" onclick="refreshValidCode(this)" /></a>
					</p>
					<div class="login_bar">
		...
		<!-- <div id="login_demo" style="margin-bottom: 150px"></div> -->
