...
<div class="pageContent">
	<form method="post" class="pageForm required-validate"
		action="${ctx}/cust/paynotice/pay4RenewAmt.do"
		...
		<div class="pageFormContent" layoutH="65">
			...
			<p>
				<label>应支付续保费用：</label>
				<input type="text" readonly="readonly" value='<fmt:formatNumber value="${trenew.renewAmt}" pattern="#,##0.00#" />' style="text-align: right;color: red;"/><span class="info">元</span>
			</p>
			<p>
				<label>已支付金额：</label>
			...
			<p>
				<label>剩余应支付：</label>
				<input type="text" readonly="readonly" value='<fmt:formatNumber value="${trenew.renewAmt - tpayNotify.havepayAmt}" pattern="#,##0.00#" />' style="text-align: right;color: red;"/><span class="info">元</span>
				<input type="hidden" id="shouldPayAmt" value="${trenew.renewAmt - tpayNotify.havepayAmt}" />
			</p>
			<p>
				<label>银行账号：</label>
