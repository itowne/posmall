	...
	<div class="pageFormContent">
		 <div class="panel collapse" defH="">
			    ...
			    <table border="1" class="list" width="100%" height="100%">
				    <tr>
						<td width="15%" align="left" style="font-weight: bolder;">物流单编号：</td>
						<td width="20%" align="left">${logisticsOrd4Page.tlogisticsOrd.innerOrdno}</td>
						<td width="15%" align="left" style="font-weight: bolder;">物流单状态：</td>
						<td width="20%" align="left"><posmall:dict dictType="logistics_ord_status" dictCode="${logisticsOrd4Page.tlogisticsOrd.logisticsOrdStatus}"></posmall:dict></td>
