...
<script type="text/javascript">
	...
	$(function() {
		...
		$("tr.data").click(function () {
        	...
        	$("#submitA").attr("href", "${ctx}/cust/logistics/toAddStep2.do?iord=" + id);
        	$("#submitA").parent().show();
        });
	...
	<form id="" method="post" action="${ctx}/cust/logistics/add.do"
		...
		<div class="formBar">
			<ul>
				<li>
					<div class="button">
						<a id="submitA" class="add" href="" target="dialog" mask="true"
							width="640" height="540" rel="CZWLXXGL_XZ" title="第二步：发货量填写"><span>&nbsp;&nbsp;下&nbsp;&nbsp;一&nbsp;&nbsp;步&nbsp;&nbsp;</span></a>
					</div>
				</li>
				<li>
					<div class="button">
