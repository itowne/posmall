...
<div class="pageContent">
	<div class="pageFormContent" layoutH="68">
		...
		<tbody>
			<c:forEach var="list" items="${warrantyDownList}" >
				<tr>
				     <td>&nbsp;${list.batchNo}</td>
				     ...
				     <td>
						<div class="panelBar tablebtn">
							<ul class="toolBar">
								<li><a class="icon" href="${ctx}/admin/warranty/warrantyDownDetail.do?id=${list.batchNo}" target="dialog" mask="true" warn="" width="640" height="540" rel="warranty_down_detail"><span>下载详情</span></a></li>
...
<script type="text/javascript">
	function downLoad(flag){
		if(flag=="query"){
			...
			document.logisticsForm.action="${ctx}/admin/warranty/warrantyDownLoad.do";
