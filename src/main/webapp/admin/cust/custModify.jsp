...
<div class="pageContent">
	<form method="post" action="${ctx}/admin/cust/custModify.do"
		class="pageForm required-validate"
		onsubmit="return validateCallback(this, dialogAjaxDone)">
		<div class="pageFormContent" layoutH="68">
			    <input type="hidden" name="icust" value="${tcustReg.icust}"/>
			 <p>
                <label>注册码：</label>
			 ...
			 <p>
                <label>客户状态：</label>
                <input type="text"  readonly="readonly"   value='<posmall:dict dictType="cust_status" dictCode="${tcust.custStatus}"></posmall:dict>'/>
             </p>
             
             <p>
                <label>采购框架合同编号：</label>
                <input type="text" maxlength="50" name="contractNo" readonly="readonly" value="${tcustReg.contractNo}"/>
	         </p>
             <p>
                <label>签署日期：</label>
                <input type="text" size="30" class="date" readonly="readonly" name="signatureDateForm" value="<fmt:formatDate value="${tcustReg.signatureDate}" pattern="yyyy-MM-dd" />"/>
             </p>
             <p>
                <label>信用状态：</label>
                <posmall:dictSelect selectName="creditLevel" dictType="credit_level" needAll="NO" defaultValue="${tcust.creditLevel}"></posmall:dictSelect>
             </p>  
			<p>
                <label>客户编号：</label>
            ...
            <p>
                <label>单位名称：</label>
                <input name="name" type="text" size="30"  value="${tcustReg.name}" readonly="readonly"/>
            </p>

            <p>
                <label>单位全称：</label>
                <input name="longName" type="text" size="30"  value="${tcustReg.longName}" readonly="readonly"/>
            </p>
            ...
            <p>
                <label>联系人姓名：</label>
                <input name="contactName" type="text" class="required"  size="30"  value="${tcustReg.contactName}"/>
            </p>
            ...
            <p>
                <label>移动电话：</label>
                <input name="mobile" type="text" class="required telphone" size="30"  value="${tcustReg.mobile}"/>
            </p>
            ...
            <p>
                <label>邮箱：</label>
                <input name="email" class="required email" type="text" size="30"  value="${tcustReg.email}"/>
            </p>
            <p>
                <label>业务员姓名：</label>
                <input name="salesmanName" type="text"  size="30" value="${tcustReg.salesmanName}"/>
            </p>
            <p>
                <label>业务员邮箱：</label>
                <input name="salesmanEmail" class="email" type="text" size="30"  value="${tcustReg.salesmanEmail}"/>
            </p>
