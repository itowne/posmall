...
<script type="text/javascript">
  function auditCust(v){
	  $("#custAuditForm_result").val(v);
	  $("#custAuditForm_result").submit();
  }
  function refuse(){
...
<div class="pageContent">
	<form id="custAuditForm" method="post" action="${ctx}/admin/cust/custAudit.do"
		class="pageForm required-validate"
		onsubmit="return validateCallback(this, dialogAjaxDone)">
		<div class="pageFormContent" layoutH="68">
			  <input type="hidden" name="icust" value="${icust}"/>
			  <input type="hidden" id="custAuditForm_result" name="custStatus" />
			<p>
                <label>注册码：</label>
            ...
            <p>
                <label>信用状态：</label>
                <input  type="text" size="30" readonly="readonly" value='<posmall:dict dictType="credit_level" dictCode="${tcust.creditLevel}"/>'/>
            </p>
			<p>
                <label>客户编号：</label>
            ...
            <p>
                ...
                <input type="text" readonly="readonly" size="30" value='<posmall:dict dictType="cust_type" dictCode="${tcustReg.custType}"></posmall:dict>' />
            </p>
            <p>
                <label>联系人姓名：</label>
			...
			<ul>
				<li><div class="button">
						<div class="buttonContent">
							<button type="button" onclick="auditCust('AUDIT_PASS');">&nbsp;&nbsp;审核通过&nbsp;&nbsp;</button>
						</div>
					</div></li>
			  <li><div class="button">
							<a type="button" target="dialog" mask="true" title="拒绝理由" href="${ctx}/admin/cust/toRefuseReason.do?icust=${icust}" onclick=""><span>&nbsp;&nbsp;拒&nbsp;&nbsp;&nbsp;&nbsp;绝&nbsp;&nbsp;</span></a>
					</div></li>
			<li><div class="button">
						<div class="buttonContent">
